...
export async function run(provider: NetworkProvider) {
    const jettonWalletFrom = provider.open(JettonWallet.createFromAddress(Address.parse("kQDC3gHQEgdmIdxXgJWAwRRTmcIwS0DWvvosPFu9c6_KH0ql")));
    ...
    //     toNano(0.14),
    //     {
    //         jettonAmount: toNano(33),
    //         vault: Address.parse("kQBFpDbB6EcDQXe9tQikpMQccuruAGAeg_1vEDjaUy-gqQ-D"),
    //         owner: provider.sender().address!,
    //         priceRate: toNano(0.033333),
